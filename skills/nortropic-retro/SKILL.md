...
Every retro (and system scope) includes the **mandatory Minneskuratering step** — classify each agent's memory entries and report them under the "Minneshälsa" heading in STEWARD-REPORT.md, even when memory is healthy.
