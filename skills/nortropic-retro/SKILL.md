...
- If the scope is a project path: run **retro mode** on that project (its reports, HANDOVER.md, brief, git log) AND a quick doctor pass (checks 1–3 only) so retros always catch mechanical breakage too.
