...
6. Build every page in the brief's architecture with the conversion trio on each: `<PhoneLink>`, `<CtaBanner>`, floating call button; sticky header with phone; hero per brief.
