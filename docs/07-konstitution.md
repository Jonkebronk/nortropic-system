...
2. **Eval-rubriken** — `skills/nortropic-eval/references/eval-rubrik.md`: kriterier, vikter, trösklar och versionsnummer. Måttet ägs av människan; systemet får aldrig ändra det det mäts mot. En agent som får redigera sin egen måttstock optimerar förr eller senare måttet i stället för kvaliteten — detta är systemets reward-hacking-skydd, inte en formalitet.
