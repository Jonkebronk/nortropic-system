...
**Exakt fil att skruva i:** research-radens `Läge: obemannat` (default `bemannat`), `workflows/nortropic-autobygg.js` (orkestreringen + de villkorade stoppen, inkl. fixkontraktets ÖVERLÄMNAD vid brutet kontrakt — BATCH-005), `workflows/nortropic-final-touches.js` (slutlistan) och frågeklassningen STRATEGISK/FAKTA/BESLUT i `agents/project-planner.md`.
